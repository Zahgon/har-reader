...
public record HarHeader(@Nullable String name, @Nullable String value, @Nullable String comment, @Nonnull Map<String, Object> additional) {

    public HarHeader() {
        this(null, null, null, new HashMap<>());
    }

    public HarHeader(@Nullable String name, @Nullable String value, @Nullable String comment, @Nullable Map<String, Object> additional) {
        this.name = name;
        this.value = value;
