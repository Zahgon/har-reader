...
public record HarCreatorBrowser(@Nullable String name, @Nullable String version, @Nullable String comment, @Nonnull Map<String, Object> additional) {

    public HarCreatorBrowser() {
        this(null, null, null, new HashMap<>());
    }

    public HarCreatorBrowser(@Nullable String name, @Nullable String version, @Nullable String comment, @Nullable Map<String, Object> additional) {
        this.name = name;
